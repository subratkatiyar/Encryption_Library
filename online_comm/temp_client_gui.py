...
#
#         # self.Frame1 = tk.Frame(master)
#         # self.Frame1.place(relx=0.2, rely=0.022, relheight=0.1, relwidth=0.625)
#         # self.Frame1.configure(relief='groove')
#         # self.Frame1.configure(borderwidth="2")
#         # self.Frame1.configure(relief="groove")
#
...
#         # self.Frame2.place(relx=0.2, rely=0.489, relheight=0.1, relwidth=0.642)
